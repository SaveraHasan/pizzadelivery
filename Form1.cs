...
namespace WindowsFormsApplication3
{
...

    {
        ...
        {
            AuthSecret = "9gO1qqRSIdhhOmg5TMWTiNcequBb6BCxXv801qnt",
            BasePath = "https://fir-pizzaapp-default-rtdb.firebaseio.com/"
        };
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            comboBox1.Items.Add("Khyber Pakhtunkhwa");
        ...
        private void button8_Click(object sender, EventArgs e, string v)
        {
        ...
        private async void button9_Click(object sender, EventArgs e)
        {
            ...
            {
                Name = textBox11.Text,
                Instruction = textBox12.Text,
                Address = textBox13.Text,
                /*Province = comboBox1.SelectedText,*/
                Contact = textBox16.Text,
                Email = textBox17.Text,
                /* PaymentMethod = comboBox2.SelectedText,*/
                Amount = textBox19.Text

            };

            SetResponse response = await client.SetTaskAsync("Information/" + textBox11.Text, data);
        ...
        private void button10_Click(object sender, EventArgs e)
        {
            ...
            /*  string savera = "admin";
              ...
              if ((textBox22.Text == savera) && (textBox23.Text == password ))
              {

                 MessageBox.Show("Login Successfully!", "WELCOME to Pizza Delivery App");
              }
            */
        }
